...
class __$$SuccesImplCopyWithImpl<$Res>
    extends _$LogoutStateCopyWithImpl<$Res, _$SuccesImpl>
...
class _$SuccesImpl with DiagnosticableTreeMixin implements _Succes {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'LogoutState.succes()';
  }

  @override
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty('type', 'LogoutState.succes'));
  }
...
abstract class _Succes implements LogoutState {
